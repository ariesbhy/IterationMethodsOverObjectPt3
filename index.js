...
function getCourse(student, courseIndex) {
  // Your code here
  let foundCourse = student.courses[courseIndex];
  return foundCourse;
}
...
function listAllCourses(students) {
  ...
  students.forEach((student) => {
    ...
    courses.forEach((course) => {
      if (!uniqueCourses.includes(course) == false) {
...
function removeCourseFromStudent(student, course) {
  // Your code here
  let courses = student.courses;
  let filterdCourses = courses.filter((studentCourse) => {
  ...
  student.courses = filterdCourses;
  return student;
}
...
function getStudentsByCourse(course, students) {
  // Your code here
  let studentInCourse = [];
  let studentsInCourse = students.filter((course) => {
    if (students.courses.includes(course)) {
      return true;
    } else {
      return false;
    }
